...
; CHECK-NEXT:    [[PREDPHI:%.*]] = select <4 x i1> [[TMP18]], <4 x i1> zeroinitializer, <4 x i1> [[TMP14]]
; CHECK-NEXT:    [[TMP16:%.*]] = select <4 x i1> [[TMP4]], <4 x i1> [[PREDPHI]], <4 x i1> zeroinitializer
; CHECK-NEXT:    [[PREDPHI9:%.*]] = select <4 x i1> [[TMP19]], <4 x i1> zeroinitializer, <4 x i1> [[TMP15]]
; CHECK-NEXT:    [[TMP17:%.*]] = select <4 x i1> [[TMP5]], <4 x i1> [[PREDPHI9]], <4 x i1> zeroinitializer
; CHECK-NEXT:    [[TMP39:%.*]] = select <4 x i1> [[TMP4]], <4 x i1> [[TMP18]], <4 x i1> zeroinitializer
; CHECK-NEXT:    [[TMP24:%.*]] = select <4 x i1> [[TMP39]], <4 x i1> [[TMP22]], <4 x i1> zeroinitializer
; CHECK-NEXT:    [[TMP49:%.*]] = select <4 x i1> [[TMP5]], <4 x i1> [[TMP19]], <4 x i1> zeroinitializer
; CHECK-NEXT:    [[TMP25:%.*]] = select <4 x i1> [[TMP49]], <4 x i1> [[TMP23]], <4 x i1> zeroinitializer
