...
; CHECK-NEXT:    [[TMP13:%.*]] = extractelement <vscale x 2 x i64> [[TMP12]], i64 0
; CHECK-NEXT:    [[TMP22:%.*]] = getelementptr i32, ptr [[P1]], i64 [[TMP13]]
; CHECK-NEXT:    [[TMP15:%.*]] = call <vscale x 2 x i32> @llvm.experimental.vp.strided.load.nxv2i32.p0.i32(ptr align 4 [[TMP22]], i32 16, <vscale x 2 x i1> splat (i1 true), i32 [[TMP9]])
